# This Makefile is for the enum extension to perl.
#
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  enum.pm $(INST_MAN3DIR)/enum.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               enum' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            1.016' >> META_new.yml
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="1.016">' > $(DISTNAME).ppd
